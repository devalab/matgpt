...
#             structures_dict[prop] = []
#             for cif_path in cif_paths:
#                 try:
#                     structures_dict[prop].append(Structure.from_file(cif_path))
#                 except Exception as e:
#                     print(f"Error loading structure from {cif_path}: {e}")

#         validity_results = {prop: [] for prop in properties}
...
#         bars = plt.bar(validity_percentages.keys(), validity_percentages.values(), color='blue', width=0.4)
...
#         plt.xticks(properties, fontsize=12)
